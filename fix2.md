...
>
> **R5-07, R5-08, R5-09, R5-11 seit diesem Update ebenfalls ✅ erledigt.** R5-10 (ESM) bewusst zurückgestellt – der Befund selbst empfiehlt „bei der nächsten fachlichen Änderung", nicht als eigenständigen Umbau. Details je Punkt in `Fix.md`. **Damit ist der komplette R5-Backlog aus diesem Re-Review abgearbeitet** (R5-10 ausgenommen, bewusst zurückgestellt).
>
...
| **8** ✅ (R5-11 erledigt, R5-10 zurückgestellt) | R5-10/R5-11 Wartung: ESM, Pins, PHPUnit-Deprecations. | Grunt, Code Checker, volle CI. | R5-11: 3 CI-Actions + moodle-plugin-ci gepinnt, PHPUnit-Deprecations 5→1 (die letzte bewusst dokumentiert, PHPUnit-9.6-Kompatibilität). R5-10: bewusst zurückgestellt, der Befund selbst empfiehlt „bei der nächsten fachlichen Änderung". |
