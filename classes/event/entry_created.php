...
/**
 * The mod_insightjournal entry created event.
 *
...
/**
 * The mod_insightjournal entry created event class.
 *
...
class entry_created extends \core\event\base {
    ...
    public function get_description() {
        return "The user with id '$this->userid' created an insight journal entry with id '$this->objectid' " .
    ...
    public static function get_name() {
        return get_string('evententrycreated', 'mod_insightjournal');
    }
