...
### R4-03 · Gruppenautorisierung speicherbegrenzt machen  `[FR]` — ✅ Erledigt (2026-08-05, `main` @ `393d4d1`, noch nicht gepusht)
...
### R4-04 · Kursreport-Service extrahieren  `[FR]` — ✅ Erledigt (2026-08-05, `main` @ `aead5d6`, noch nicht gepusht)
...
5. ~~**R4-04** – Kursreport-Service~~ — ✅ erledigt (siehe oben) / **R4-05** – Template-Test bereinigen (noch offen)
