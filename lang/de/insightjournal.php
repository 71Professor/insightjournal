...
$string['entriesvisibility_help'] = 'Legt fest, ob Trainer/innen mit der Fähigkeit „Alle Einträge ansehen" die Einträge dieser Aktivität sehen können. Mit „Für Trainer/innen sichtbar" (Standard) können sie die Einträge im Bericht, im Kursbericht und in der persönlichen Übersicht lesen. Mit „Privat" bleiben die Einträge nur für die verfassende Person sichtbar; Trainer/innen sehen stattdessen einen Hinweistext. Dies wird pro Aktivität festgelegt; eine globale Einstellung gibt es nicht.';
