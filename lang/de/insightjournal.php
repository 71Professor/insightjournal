...
$string['prompttext_help'] = 'Der Impuls oder die Frage, die den Teilnehmenden angezeigt wird. Jede Insight-Journal-Aktivität enthält genau einen Impuls, auf den die Teilnehmenden antworten.';
$string['promptcolor'] = 'Hintergrundfarbe des Impulses';
$string['promptcolor_help'] = 'Ein optionaler Hex-Farbcode (z. B. #ffcc00) für den Hintergrund des Insight-Impulses, überall dort, wo er angezeigt wird. Dies betrifft nur den Impuls, niemals die Antwort einer/eines Teilnehmenden. Leer lassen, um die Standarddarstellung zu verwenden.';
