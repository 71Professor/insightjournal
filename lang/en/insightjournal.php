...
$string['promptcolor'] = 'Prompt background colour';
$string['promptcolor_help'] = 'An optional hex colour code (e.g. #ffcc00) used as the background of the insight prompt box, wherever it is shown. This only affects the prompt, never a learner\'s response. Leave blank to use the default appearance.';
...
$string['entriesvisibility'] = 'Trainer visibility for this activity';
$string['entriesvisibility_sitedefault'] = 'Use site default';
$string['entriesvisibility_visible'] = 'Visible to trainer';
$string['entriesvisibility_private'] = 'Private (only visible to learner)';
$string['entriesvisibility_help'] = 'Controls whether trainers/teachers with the "View all entries" capability can see this activity\'s entries. "Use site default" follows the site-wide Insight Journal setting (Site administration → Plugins → Activity modules → Insight Journal), including any later changes the site administrator makes to it. Choosing "Visible to trainer" or "Private" overrides that site default for this activity only.';
