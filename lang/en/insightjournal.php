...
$string['err_emptyprompt'] = 'Enter a task or question - the prompt cannot be empty.';
...
$string['evententrycreated'] = 'Insight journal entry created';
$string['evententryupdated'] = 'Insight journal entry updated';
...
$string['minchars_help'] = 'The minimum number of characters a response must contain before the activity is marked complete. Set to 0 to require no minimum length. This only gates completion - learners can always save a shorter response, it just will not count as complete yet.';
...
$string['promptcolorpicker'] = 'Task / Question background colour picker';
