...
$string['entriesvisibility_help'] = 'Controls whether trainers/teachers with the "View all entries" capability can see this activity\'s entries. With "Visible to trainer" (default) they can read the entries in the report, course report, and personal summary pages. With "Private" the entries stay visible to the learner who wrote them only, and trainers see a notice instead of entry content. This is set per activity; there is no site-wide setting.';
